    ...
    getEntries = async () => {
        ...
        await fetch("/api/filter-instructorlist/", request).then((response) => {
            response.json().then((data) => {
                ...
                this.state.displayedInstructors.slice((this.state.currentPage - 1) * this.state.perPage, this.state.currentPage * this.state.perPage).map((item) => {
                            ...
                            <Table striped>
                                ...
                                <tbody>
                                    {this.state.displayedInstructors === null ? (
                                        ...
                                        this.state.displayedInstructors.slice((this.state.currentPage - 1) * this.state.perPage, this.state.currentPage * this.state.perPage).map((item, index) => {
                                            {
                                                /**5 courses */
                                            }
                                            return (
