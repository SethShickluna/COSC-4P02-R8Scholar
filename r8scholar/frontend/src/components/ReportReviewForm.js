...
function ReportForm(props) {
    ...
    const reasons = ["It contains offensive content", "It is clearly untrue", "Does not contain relevant information to this Course/Instructor/Department"];
    ...
    return (
        <>
            <Button className="btn-round" color="danger" type="button" onClick={() => setLoginModal(true)}>
                <BsFillExclamationCircleFill /> Report
            </Button>
            <Modal isOpen={loginModal} toggle={() => setLoginModal(false)} modalClassName="modal-register">
                <div className="modal-header no-border-header text-center" id="reportReview">
                ...
                <div className="modal-body" id="reportReview">
                    <FormGroup tag="fieldset">
                        ...
                        <FormGroup check>
                            <Label check>
                                <Input type="radio" onClick={handlePress} id="3" name="radio1" /> Does not contain relevant information to this Course/Instructor/Department
                            </Label>
                        </FormGroup>
                        <FormGroup check>
                            <Label check>
