...
export default class BanUserForm extends Component {
        ...
        return (
            <div>
                <Card style={formStyle}>
                    <Card.Header as='h4'>Ban User</Card.Header>
                    <Card.Body>
                        <Form>
                            <Form.Group controlId="formGroupName">
                                <Form.Label>User Name</Form.Label>
                                <Form.Control type="name" onChange={this.updateNameInput} placeholder="Enter Username..." />
                            </Form.Group>
