...
class ReviewSerializer(serializers.ModelSerializer):
    class Meta:
        model = Review
        fields = ('review_id','email', 'nickname', 'subject','title', 'content', 'instructor_rating', \
            'course_rating', 'numb_reports', 'date_created', 'department_name', 'instructor_name')
...
class CourseSerializer(serializers.ModelSerializer):
    class Meta:
        model = Course
        fields = ('code', 'course_name', 'department_name', 'course_rating', 'instructor_name')

class DeparmentSerializer(serializers.ModelSerializer):
    class Meta:
        model = Department
        fields = ('department_name', 'courses_rating', 'instructors_rating', 'overall_rating')

class InstructorSerializer(serializers.ModelSerializer):
    class Meta:
        model = Instructor
        fields = ('instructor_name', 'department_name', 'instructor_rating')
...
class CreateReviewSerializer(serializers.ModelSerializer): 
    class Meta: 
        model = Review
        fields = ('email','nickname','title', 'content', 'instructor_rating','course_rating','code', 'instructor_name', )
